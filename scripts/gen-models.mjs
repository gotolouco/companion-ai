// Gera src/lib/models.js a partir dos arquivos .vrm em public/models/.
// Uso: node scripts/gen-models.mjs  (ou: npm run models)
...
// Transforma "Darkness_Shibu.vrm" -> "Darkness Shibu"
